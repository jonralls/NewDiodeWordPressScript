...
wp theme install https://github.com/DiscipleTools/disciple-tools-theme/releases/latest/download/disciple-tools-theme.zip --allow-root --path="/srv/www/wordpress"
wp theme activate disciple-tools-theme --allow-root --path="/srv/www/wordpress"
